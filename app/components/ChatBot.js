...
export default function ChatBot({ conversation, onAddConversation }) {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      //   if (user) {
      //     if (!conversationId) {
      //       const name = newMessage.content || assistantMessage.content;
      //       // If there's no conversation ID, this is a new conversation
      //       const newConversationId = await saveConversationToFirebase(
      //         [...messages, newMessage, assistantMessage],
      //         user.uid,
      //         name
      //       );
      //       setConversationId(newConversationId); // Save the conversation ID
      //     } else {
      ...
      //       // If conversation is bookmarked and we have an ID, update it
      //       await updateBookmarkedConversation(
      //         user.uid,
      //         conversationId,
      //         newMessage
